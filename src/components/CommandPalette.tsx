...
export default function CommandPalette({ onClose, onCommand, isDark, isMobile }: Props) {
  ...
  const portal = createPortal(
    <>
      ...
      >
                  ...
                  {cmds.map(cmd => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {cmd.shortcut && (
                          <span className="db-cmd-shortcut hidden md:block">
                            {cmd.shortcut}
                          </span>
                        )}
        ...
        <div className="db-cmd-footer hidden sm:flex">
